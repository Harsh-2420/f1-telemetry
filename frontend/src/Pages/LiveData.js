...
export const LiveData = () => {
	...
	useEffect(() => {
		dataQueues.carTelemetryDataQueue.setNewDataCallback(() => NewPacket(dataQueues.carTelemetryDataQueue, setCarTelemetryData));
		dataQueues.carStatusDataQueue.setNewDataCallback(() => NewPacket(dataQueues.carStatusDataQueue, setCarStatusData));
		dataQueues.lapDataQueue.setNewDataCallback(() => NewPacket(dataQueues.lapDataQueue, setLapData));
